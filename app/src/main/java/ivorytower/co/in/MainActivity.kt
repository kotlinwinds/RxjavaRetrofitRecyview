...
import ivorytower.co.`in`.adapter.RecyclerAdapter
import ivorytower.co.`in`.model.UserModel
import ivorytower.co.`in`.retrofit.APIInterface
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setAdapter() {
        recyclerAdapter = RecyclerAdapter(list, object : RecyclerAdapter.ItemClickListener {
            override fun onItemClicked(repos: UserModel?) {
               Toast.makeText(applicationContext,"Item Click: ${repos!!.title} ",Toast.LENGTH_SHORT).show()
            }
